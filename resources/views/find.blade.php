				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul class="list-group" v-show="distanceToggle">
							<li class="list-group-item">
								<form method="POST" v-on:submit.prevent="onSubmitDistanceForm">
									<div class="row">
										<div class="form-group">
											...
											<div class="col-md-6" id="" style="">
												<label for="exampleInputEmail1">Distance From Location</label>
						...
						<ul class="list-group" v-show="islandToggle">
							<li class="list-group-item">
